...
from support.app_context import build_page_context, initialize_page, render_page_links, render_shared_sidebar, team_format_label
...
def main() -> None:
    ...
    render_hero("Weekend Hub", subtitle, meta)
    render_page_links("Weekend Hub")
    render_chip_row(
        [
            "Tournament home screen",
            "Overall race and fixture cards",
            "Quick paths into scoring, match centre, and course guide",
        ],
        tone="accent",
    )
    render_weekend_hub(
